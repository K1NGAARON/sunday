...
let blanketBtn = document.querySelector("#blanket-btn");
let towelBtn = document.querySelector("#towel-btn");
let bathrobesBtn = document.querySelector("#bathropes-btn");
...
function showSliders() {
    firstSlide.src = "/wp-content/uploads/2022/03/Sliders-1.jpg";
    secondSlide.src = "/wp-content/uploads/2022/03/Flipflops.jpg";
    thirdSlide.src = "/wp-content/uploads/2022/03/Sliders-1.jpg";
};
